            ...
            <aside class="admin-sidebar">
                ...
                <nav>
                     <ul class="sidebar-menu">
                        <li class="menu-item <?php echo ($currentPage == 'admin.php') ? 'active' : ''; ?>"><a href="admin.php"><i class="material-icons">dashboard</i> Dashboard</a></li>
                         <li class="menu-item <?php echo ($currentPage == 'update.php') ? 'active' : ''; ?>"><a href="update.php"><i class="material-icons">file_upload</i> Upload Management</a></li>
                    ...
                    <ul class="sidebar-menu user-management-menu">
                        ...
                        <li class="menu-item <?php echo ($currentPage == 'customer_database.php') ? 'active' : ''; ?>"><a href="customer_database.php"><i class="material-icons">people</i> Customer Database</a></li>
                        <li class="menu-item <?php echo ($currentPage == 'reports.php') ? 'active' : ''; ?>"><a href="reports.php"><i class="material-icons">analytics</i>Reservation Reports</a></li>
                        <li class="menu-item <?php echo ($currentPage == 'deletion_history.php') ? 'active' : ''; ?>"><a href="deletion_history.php"><i class="material-icons">history</i>Archive</a></li>
